...
The template for parser.p4 can be found [here](https://github.com/p4lang/switch/blob/master/p4src/includes/parser.p4). In our case, the parsing tree is as following: ![alt-text](https://docs.google.com/drawings/d/1gP6B_rGYv1bmhj_pWoPDT2ERZ0YBaojdfEWXiT7iYuM/edit?usp=sharing).
